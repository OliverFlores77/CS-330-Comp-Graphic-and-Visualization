...
//  Modified by Oliver Flores - SNHU Student / Computer Science
///////////////////////////////////////////////////////////////////////////////
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	// upward/downward movement with Q and E keys
...
void ViewManager::PrepareSceneView()
{
	...
	// Check if orthographic projection is enabled
	if (bOrthographicProjection)
	{
		// Orthographic projection - no perspective, objects appear flat
		// Parameters: left, right, bottom, top, near, far
		// The camera looks directly at the scene without depth distortion
		projection = glm::ortho(-8.0f, 8.0f, -6.0f, 6.0f, 0.1f, 100.0f);
	}
	else
	{
		// Perspective projection - creates 3D effect with depth
